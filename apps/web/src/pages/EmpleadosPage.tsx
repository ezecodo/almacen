          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="····"
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-2xl tracking-widest text-center font-bold focus:outline-none focus:border-indigo-400"
              />
            </div>
            <button
                  ...
                  {editando?.id === emp.id ? (
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-3">
                        <input
                          ...
                          className="w-24 border border-indigo-300 rounded-lg px-3 py-2 text-sm text-center tracking-widest font-bold focus:outline-none"
                        />
                        <div className="ml-auto flex gap-3">
                          ...
                          <button
                            ...
                            className="text-sm text-indigo-600 font-semibold hover:text-indigo-800 disabled:opacity-40"
                          >
                            Guardar
                          </button>
                        </div>
                    ...
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <div className="flex gap-3 shrink-0">
                        <button onClick={() => setEditando(emp)} className="text-sm text-indigo-500 hover:text-indigo-700">Editar</button>
                        <button
